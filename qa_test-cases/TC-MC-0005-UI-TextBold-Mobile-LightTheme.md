---
id: TC-MC-0005
title: "UI-kit: TextBold – Mobile – Light Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0005 — UI: TextBold – Mobile – Light Theme – Typography Tokens
...
- This test case covers only **Mobile (≤767px) + Light theme**.
- Complementary test cases cover Desktop/Tablet and Dark theme variants.
