...
- Screenshot of `H1` rendering on Desktop + Light theme at ≥1193px width (showing default or example heading text)
...
- This test case covers only **Desktop (≥1193px) + Light theme** for the `H1` component.
