---
id: TC-MC-0030
title: "UI-kit: H1 – Mobile – Dark Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0030 — UI: H1 – Mobile – Dark Theme – Typography Tokens

## Objective

Validate that the `H1` UI component renders correctly on **Mobile** viewport in **Dark theme**, using the expected typography design tokens and semantic `<h1>` behavior defined in ticket  
...
- Screenshot of `H1` rendering on Mobile + Dark theme at ~375px width (showing default or example heading text)
...
- This test case covers only **Mobile (<768px) + Dark theme** for the `H1` component.
...
- Related test cases (planned or existing):
	- [TC-MC-0026 – H1 – Desktop – Dark Theme](./TC-MC-0026-UI-H1-Desktop-DarkTheme.md)
	- [TC-MC-0028 – H1 – Tablet – Dark Theme](./TC-MC-0028-UI-H1-Tablet-DarkTheme.md)
	- [TC-MC-0029 – H1 – Mobile – Light Theme](./TC-MC-0029-UI-H1-Mobile-LightTheme.md)
