---
id: TC-MC-0027
title: "UI-kit: H1 – Tablet – Light Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0027 — UI: H1 – Tablet – Light Theme – Typography Tokens
...
- Screenshot of `H1` rendering on Tablet + Light theme at ~1024px width (showing default or example heading text)
