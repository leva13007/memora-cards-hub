---
id: TC-MC-0035
title: "UI-kit: H2 – Mobile – Light Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0035 — UI: H2 – Mobile – Light Theme – Typography Tokens

## Objective

Validate that the `H2` UI component renders correctly on **Mobile** viewport in **Light theme**, using the expected typography design tokens and semantic `<h2>` behavior defined in ticket  
...
- Screenshot of `H2` rendering on Mobile + Light theme at ~375px width (showing default or example heading text)
...
- Verify that global theme toggling Light → Dark → Light correctly updates `--color-text` for H2 and does not break typography tokens.

---

## Notes

- This test case covers only **Mobile (<768px) + Light theme** for the `H2` component.
...
- Related test cases (planned or existing):
	...
	- [TC-MC-0033 – H2 – Tablet – Light Theme](./TC-MC-0033-UI-H2-Tablet-LightTheme.md)
	- (future) H2 – Mobile – Dark Theme
	- [TC-MC-0011 – TextMedium – Mobile – Light Theme](../TextMedium/TC-MC-0011-UI-TextMedium-Mobile-LightTheme.md)
	- [TC-MC-0023 – TextLink – Mobile – Light Theme](../TextLink/TC-MC-0023-UI-TextLink-Mobile-LightTheme.md)
