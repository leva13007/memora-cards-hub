...
- Screenshot of `H2` rendering on Desktop + Dark theme at ≥1193px width (showing default or example heading text)
...
- This test case covers only **Desktop (≥1193px) + Dark theme** for the `H2` component.
