---
id: TC-MC-0032
title: "UI-kit: H2 – Desktop – Dark Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0032 — UI: H2 – Desktop – Dark Theme – Typography Tokens

## Objective

Validate that the `H2` UI component renders correctly on **Desktop** viewport in **Dark theme**, using the expected typography design tokens and semantic `<h2>` behavior defined in ticket  
...
- Screenshot of `H2` rendering on Desktop + Dark theme at ≥1280px width (showing default or example heading text)
...
- Verify that global theme toggling Dark → Light → Dark correctly updates `--color-text` for H2.

---

## Notes

- This test case covers only **Desktop (≥1280px) + Dark theme** for the `H2` component.
...
- Related test cases (planned or existing):
	...
	- (future) H2 – Tablet – Light/Dark Theme
