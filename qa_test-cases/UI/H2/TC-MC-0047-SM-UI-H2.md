---
id: TC-MC-0047-SM
title: "SM / UI: H2 — Storybook page loads without errors"
...
# TC-MC-0047-SM — SM / UI: H2 — Storybook page loads without errors

## Objective
Quick smoke check that the `H2` Storybook story loads successfully and does not produce runtime errors.
...
## Steps
1. Open the H2 Storybook story (iframe):
	- Story: [link](https://leva13007.github.io/memora-cards-storybook/iframe.html?id=ui-atoms-h2--default&viewMode=story)
