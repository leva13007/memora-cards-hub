---
id: TC-MC-0049-SM
title: "SM / UI: TextLight — Storybook page loads without errors"
...
# TC-MC-0049-SM — SM / UI: TextLight — Storybook page loads without errors

## Objective
Quick smoke check that the `TextLight` Storybook story loads successfully and does not produce runtime errors.
...
## Steps
1. Open the TextLight Storybook story (iframe):
	- Story: [link](https://leva13007.github.io/memora-cards-storybook/iframe.html?id=ui-atoms-textlight--default&viewMode=story)
...
- The `TextLight` story renders content.
