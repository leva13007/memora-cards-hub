---
id: TC-MC-0022
title: "UI-kit: TextLink – Tablet – Dark Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0022 — UI: TextLink – Tablet – Dark Theme – Typography & Link Tokens

## Objective

Validate that the `TextLink` UI component renders correctly on **Tablet** viewport in **Dark theme**, using the expected typography design tokens (inheriting from `TextMedium`) and link-specific color tokens defined in ticket  
...
- Screenshot of `TextLink` rendering on Tablet + Dark theme (showing default state)

![alt text](../../assets/image-22.png)

- Screenshot of `TextLink` rendering on Tablet + Dark theme (showing hover state)

![alt text](../../assets/image-22-h.png)
...
- Test very long `content` strings to verify wrapping and hover behavior across multiple lines at tablet width and in Dark theme.
...
- This test case covers only **Tablet (768–1279px) + Dark theme** for the `TextLink` component.
- Separate test cases should cover Light theme and Desktop/Mobile variants.
- Typography expectations should match `TextMedium` Tablet + Dark behavior, except for using link-specific color tokens instead of `--color-text`.
