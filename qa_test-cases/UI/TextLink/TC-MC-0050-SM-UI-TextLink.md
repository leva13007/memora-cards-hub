---
id: TC-MC-0050-SM
title: "SM / UI: TextLink — Storybook page loads without errors"
...
# TC-MC-0050-SM — SM / UI: TextLink — Storybook page loads without errors

## Objective
Quick smoke check that the `TextLink` Storybook story loads successfully and does not produce runtime errors.
...
## Steps
1. Open the TextLink Storybook story (iframe):
	- Story: [link](https://leva13007.github.io/memora-cards-storybook/iframe.html?id=ui-atoms-textlink--default&viewMode=story)
...
- The `TextLink` story renders content.
