---
id: TC-MC-0009
title: "UI-kit: TextMedium – Tablet – Light Theme – Typography Tokens"
type: UI
priority: Medium
...
# TC-MC-0009 — UI: TextMedium – Tablet – Light Theme – Typography Tokens
...
- This test case covers only **Tablet (768–1279px) + Light theme** for the `TextMedium` component.
...
- Related test cases:
	...
	- (future) TextMedium – Tablet/Mobile + Dark theme
