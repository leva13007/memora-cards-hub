---
id: TC-MC-0051-SM
title: "SM / UI: TextMedium — Storybook page loads without errors"
...
# TC-MC-0051-SM — SM / UI: TextMedium — Storybook page loads without errors

## Objective
Quick smoke check that the `TextMedium` Storybook story loads successfully and does not produce runtime errors.
...
## Steps
1. Open the TextMedium Storybook story (iframe):
	- Story: [link](https://leva13007.github.io/memora-cards-storybook/iframe.html?id=ui-atoms-textmedium--default&viewMode=story)
...
- The `TextMedium` story renders content.
