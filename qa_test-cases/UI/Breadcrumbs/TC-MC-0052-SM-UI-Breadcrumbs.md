---
id: TC-MC-0052-SM
title: "SM / UI: Breadcrumbs — Storybook page loads without errors"
...
# TC-MC-0052-SM — SM / UI: Breadcrumbs — Storybook page loads without errors

## Objective
Quick smoke check that the `Breadcrumbs` Storybook story loads successfully and does not produce runtime errors.
...
## Steps
1. Open the Breadcrumbs Storybook story (iframe):
	- Story: [link](https://leva13007.github.io/memora-cards-storybook/iframe.html?id=ui-molecules-breadcrumbs--default&viewMode=story)
...
- The `Breadcrumbs` story renders content.
...
## Notes
- This is a smoke test only; it does not validate accessibility or semantics.
